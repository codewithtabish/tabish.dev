...
const bentoItems: BentoItem[] = [
  {
    id: "main",
    title: "Code with Tabish",
    description:
      "Building modern, scalable, and intelligent web applications with Next.js, Node.js, and AI-powered features.",
    href: "#",
    feature: "spotlight",
    spotlightItems: [
  ...
  },
  {
    ...
    description:
      "Integrating ChatGPT, Gemini, and other LLMs to build intelligent systems that enhance productivity and creativity.",
    href: "#",
    feature: "typing",
    typingText: `const aiTool = async () => {
  ...
  },
  {
    ...
    title: "Tech Stack",
    description:
      "I work with leading frameworks and APIs to create efficient and future-ready applications.",
    icons: true,
    href: "#",
    feature: "icons",
    size: "md",
  ...
  },
  {
    ...
    description:
      "From learning code to deploying AI-driven products — my developer journey so far.",
    href: "#",
    feature: "timeline",
    timeline: [
      { year: "2020", event: "Started learning programming" },
      { year: "2021", event: "Built first full-stack web app" },
      { year: "2022", event: "Explored AI tools and automation" },
      { year: "2023", event: "Launched CodewithTabish.com" },
      { year: "2024", event: "Integrated AI into real-world projects" },
    ],
    size: "sm",
    className: "col-span-1 row-span-1",
  },
...
export default function DashboardBentoGrid() {
    return (
        <section className="relative  sm:py-32 bg-white dark:bg-background/20  overflow-hidden">
