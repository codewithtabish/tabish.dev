...
export function ExperienceItem({
  ...
  return (
    <div className="space-y-4 py-4 md:max-w-4xl mx-auto">
      <div className="flex flex-col gap-1">

   <h2 className="font-bold text-3xl">Work Experience</h2>
<p>
  I’ve gained hands-on experience working across multiple roles in web, mobile, and backend development.  
  Each position helped me strengthen my skills and build real-world solutions with modern technologies.
</p>
      </div>
